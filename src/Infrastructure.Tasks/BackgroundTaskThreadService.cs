...
namespace Infrastructure.Tasks
{
    ...
    public class BackgroundTaskThreadService<TThread> : IDisposable
        where TThread : BackgroundTaskThread, new()
    {
        #region constructors
        ...
        /// <param name="e"></param>
        protected void OnThreadStarted(object sender, TaskThreadStartEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void OnThreadExited(object sender, TaskThreadExitEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void OnTaskBuildFaulted(object sender, TaskBuildEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void OnTaskExecuting(object sender, TaskExecutingEventArgs e)
        {
        ...
        protected void OnTaskExecuted(object sender, TaskExecuteEventArgs e)
        {
            if (disposed)
            {
                throw new ObjectDisposedException("BackgroundTaskThreadService");
            }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void OnServiceStoped(object sender, ServiceStopEventArgs e)
        {
            ServiceStoped?.Invoke(sender, e);
        }
        ...
        private void InitializeTaskThreads()
        {
            ...
            for (int i = 0; i < ThreadCount; i++)
            {
                ...
                taskThread.TaskExecuting += new TaskExecutingEventHandler(OnTaskExecuting);
                taskThread.TaskExecuted += new TaskExecuteEventHandler(OnTaskExecuted);
        ...
        public void Stop()
        {
            ...
            // 通知服务已停止。
            OnServiceStoped(this, new ServiceStopEventArgs() { IsSafeExited = IsSafeExited });
        }
