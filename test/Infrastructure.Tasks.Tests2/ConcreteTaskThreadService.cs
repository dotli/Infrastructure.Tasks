...
{
    internal class ConcreteTaskThreadService : BackgroundTaskThreadService<ConcreteTaskThread>
    {
        ...
        static void ConreteService_TaskExecuted(object sender, TaskExecuteEventArgs e)
        {
            Console.WriteLine("{0}\t{1} executed task({2}) with {3}ms.",
                DateTime.Now.ToLongTimeString(), e.Thread.Name, e.Task.Id.ToString(), e.Milliseconds.ToString());
        }

        static void ConreteService_TaskExecuting(object sender, TaskExecutingEventArgs e)
        {
            Console.WriteLine("{0}\t{1} executing task({2})...",
                DateTime.Now.ToLongTimeString(), e.Thread.Name, e.Task.Id.ToString());
        }

        static void ConreteService_ThreadExited(object sender, TaskThreadExitEventArgs e)
        {
            Console.WriteLine("{0}\t{1} exited.",
                DateTime.Now.ToLongTimeString(), e.Thread.Name);
        }

        static void ConreteService_ThreadStarted(object sender, TaskThreadStartEventArgs e)
        {
    ...
    internal class ConcreteTaskThread : BackgroundTaskThread
    {
        ...
        {
            ConcreteTask concreteTask = task as ConcreteTask;
